<?php
/**
* The cyberguard_Admin initiate the theme admin
*/
...
class cyberguard_Admin extends cyberguard_Base{
    ...
    public function fix_parent_menu() {
		...
		$submenu['pxlart'][0][0] = cyberguard()->get_name().' '.esc_html__( 'Dashboard', 'cyberguard' );
