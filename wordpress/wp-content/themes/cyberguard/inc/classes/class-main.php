...
if (!class_exists('cyberguard_Main')) { 
    class cyberguard_Main extends cyberguard_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new cyberguard_Main();
            }
...
function cyberguard() {
    return cyberguard_Main::getInstance();
}
// Install
cyberguard(); 
