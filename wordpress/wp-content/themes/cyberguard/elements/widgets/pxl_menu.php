...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_menu',
        'title' => esc_html__('BR Nav Menu', 'cyberguard'),
        'icon' => 'eicon-nav-menu',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'menu',
                            'label' => esc_html__('Select Menu', 'cyberguard'),
                ...
                array(
                    ...
                    'label' => esc_html__('First Level', 'cyberguard'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'color_active',
                            'label' => esc_html__('Color Active', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'arrow_color',
                            'label' => esc_html__('Arrow Color', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Hover/Active Color', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Has Children - Font Size', 'cyberguard' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Hover/Active Style', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            'name' => 'flex_grow',
                            'label' => esc_html__('Flex Grow', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'inherit' => [
                                    'title' => esc_html__( 'Inherit', 'cyberguard' ),
                ...
                array(
                    ...
                    'label' => esc_html__('Sub Level', 'cyberguard'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'sub_color',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Color Hover/Actvie', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'sub_bg_color',
                            'label' => esc_html__('Box Background Color', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Show Effect', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
