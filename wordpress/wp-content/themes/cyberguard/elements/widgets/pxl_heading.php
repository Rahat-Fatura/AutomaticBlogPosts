...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_heading',
        'title' => esc_html__('BR Heading', 'cyberguard' ),
        'icon' => 'eicon-heading',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'sub_title',
                            'label' => esc_html__('Sub Title', 'cyberguard' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Divider Animate', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                        ...
                        array(
                            'name' => 'title_tag',
                            'label' => esc_html__('HTML Tag', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'h1' => 'H1',
                                'h2' => 'H2',
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Title Shadow', 'cyberguard' ),
                        ...
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => cyberguard_widget_animate_v2(),
                            'default' => '',
                        ),
                        array(
                    ...
                    'controls' => array_merge(
                        array(
                            ...
                            array(
                                ...
                                'label' => esc_html__('Sub Title Color', 'cyberguard' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                ...
                array(
                    ...
                    'label' => esc_html__('Highlight Text', 'cyberguard' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array_merge(
                        array(
                            array(
