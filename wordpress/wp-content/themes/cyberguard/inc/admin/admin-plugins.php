...
class cyberguard_Admin_Plugins extends cyberguard_Admin_Page {
	...
	public function __construct() {
		...
		$this->page_title = esc_html__( 'Install Plugins', 'cyberguard' );
		$this->menu_title = esc_html__( 'Install Plugins', 'cyberguard' );
		$this->parent = 'pxlart';
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
				$btn_class = 'white';
				$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'cyberguard' );
			...
			case 'installed':
				$btn_class = 'success';
				$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'cyberguard' );
			...
			case 'active':
				$btn_class = 'danger';
				$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'cyberguard' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'cyberguard' );
