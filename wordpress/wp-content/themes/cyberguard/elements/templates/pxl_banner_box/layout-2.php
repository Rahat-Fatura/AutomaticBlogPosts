...
<div id="<?php echo esc_attr($html_id); ?>" class="pxl-banner-box pxl-banner-box2 <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
