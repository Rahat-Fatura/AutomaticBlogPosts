<?php 
$logo_m = cyberguard()->get_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$p_menu = cyberguard()->get_page_opt('p_menu');
$sticky_scroll = cyberguard()->get_opt('sticky_scroll');
...
$mobile_style = cyberguard()->get_opt('mobile_style');
$mobile_display = cyberguard()->get_opt('mobile_display');
?>
                    ...
                    <div class="row">
                        ...
                        <div class="pxl-header-menu">
                            <div class="pxl-header-menu-scroll">
                                ...
                                <?php cyberguard_header_mobile_search_form(); ?>
