 ...
 * Swipper Lib
*/
if(!function_exists('cyberguard_elements_scripts')){
    add_action( 'wp_enqueue_scripts', 'cyberguard_elements_scripts');
    function cyberguard_elements_scripts() {  
        ...
        wp_register_script('cyberguard-particle', get_template_directory_uri() . '/elements/widgets/js/particle.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('cyberguard-parallax', get_template_directory_uri() . '/elements/widgets/js/parallax.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        ...
        wp_register_script('cyberguard-counter', get_template_directory_uri() . '/elements/widgets/js/counter.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('cyberguard-accordion', get_template_directory_uri() . '/elements/widgets/js/accordion.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('cyberguard-tabs', get_template_directory_uri() . '/elements/widgets/js/tabs.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('cyberguard-progressbar', get_template_directory_uri() . '/elements/widgets/js/progressbar.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_register_script('cyberguard-countdown', get_template_directory_uri() . '/elements/widgets/js/countdown.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        ...
        wp_register_script('cyberguard-pie-chart', get_template_directory_uri() . '/elements/widgets/js/pie-chart.js', [ 'jquery' ], $theme->get( 'Version' ), true);
        wp_enqueue_script('cyberguard-elementor', get_template_directory_uri() . '/elements/widgets/js/elementor.js', [ 'jquery' ], $theme->get( 'Version' ), true);

        wp_register_script('cyberguard-postclick', get_template_directory_uri() . '/elements/widgets/js/postclick.js', [ 'jquery' ], $theme->get( 'Version' ), true);
...
*/
/**if(!function_exists('cyberguard_register_custom_icon_library')){
    add_filter('elementor/icons_manager/native', 'cyberguard_register_custom_icon_library');
    function cyberguard_register_custom_icon_library($tabs){
        $custom_tabs = [
            'pxl_icon1' => [
                'name' => 'flaticon',
                'label' => esc_html__( 'cyberguard', 'cyberguard' ),
                'url' => false,
                'enqueue' => false,
                'prefix' => 'flaticon-',
...
*/
if(!function_exists('cyberguard_get_class_widget_path')){
    function cyberguard_get_class_widget_path(){
...
*/
function cyberguard_get_post_type_options($pt_supports=[]){
...
*/
function cyberguard_get_post_grid_layout($pt_supports = []){
    $post_types  = cyberguard_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            'name'     => 'layout_'.$name,
            'label'    => sprintf(esc_html__( 'Select Template of %s', 'cyberguard' ), $label),
            'type'     => 'layoutcontrol',
            'default' => 'post-1',
            'options'  => cyberguard_get_grid_layout_options($name),
...
function cyberguard_get_grid_layout_options($post_type_name){
    $option_layouts = [];
...
function cyberguard_get_grid_term_by_post_type($pt_supports = [], $args=[]){
    ...
    foreach ($post_types as $name => $label) {
        ...
        $result[] = array(
            'name'     => 'source_'.$name,
            'label'    => sprintf(esc_html__( 'Select Term of %s', 'cyberguard' ), $label),
...
function cyberguard_get_grid_ids_by_post_type($pt_supports = [], $args = []){
    $args = wp_parse_args($args, ['condition' => 'post_type', 'custom_condition' => []]);
    $post_types = cyberguard_get_post_type_options($pt_supports);
    $result = [];
    if (!is_array($post_types))
    ...
    foreach ($post_types as $name => $label) {
        ...
        $posts = cyberguard_list_post($name, false);
 
        $result[] = array(
            'name' => 'source_' . $name . '_post_ids',
            'label' => sprintf(esc_html__('Select posts', 'cyberguard'), $label),
            'type'     => \Elementor\Controls_Manager::SELECT2,
            'multiple' => true,
            'options' => $posts,
            'condition' => array_merge(
...
*/
function cyberguard_get_post_list_layout($pt_supports = []){
    $post_types  = cyberguard_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'post-1',
            'options'  => cyberguard_get_list_layout_options($name),
...
function cyberguard_get_list_layout_options($post_type_name){
    $option_layouts = [];
    switch ($post_type_name) {
        case 'post':
        $option_layouts = [
...
*/
function cyberguard_get_post_carousel_layout($pt_supports = []){
    $post_types  = cyberguard_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'portfolio-1',
            'options'  => cyberguard_get_carousel_layout_options($name),
            'prefix_class' => 'post-layout-',
            'condition' => [
                'post_type' => [$name]
            ]
...
function cyberguard_get_carousel_layout_options($post_type_name){
    $option_layouts = [];
    switch ($post_type_name) {
        case 'portfolio':
            $option_layouts = [
...
function cyberguard_get_carousel_term_by_post_type($pt_supports = [], $args=[]){
    $args = wp_parse_args($args, ['condition' => 'post_type', 'custom_condition' => []]);
    $post_types  = cyberguard_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
...
*/
function cyberguard_get_post_modern_layout($pt_supports = []){
    $post_types  = cyberguard_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'portfolio-1',
            'options'  => cyberguard_get_modern_layout_options($name),
            'prefix_class' => 'post-layout-',
            'condition' => [
                'post_type' => [$name]
            ]
...
function cyberguard_get_modern_layout_options($post_type_name){
    $option_layouts = [];
    switch ($post_type_name) {
...
*/
function cyberguard_get_post_slip_layout($pt_supports = []){
    $post_types  = cyberguard_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'service-1',
            'options'  => cyberguard_get_slip_layout_options($name),
...
function cyberguard_get_slip_layout_options($post_type_name){
    $option_layouts = [];
    switch ($post_type_name) {
...
*/
function cyberguard_get_post_click_layout($pt_supports = []){
    $post_types  = cyberguard_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'portfolio-1',
            'options'  => cyberguard_get_click_layout_options($name),
...
function cyberguard_get_click_layout_options($post_type_name){
    $option_layouts = [];
    switch ($post_type_name) {
...
*/
function cyberguard_get_portfolio_click_layout($pt_supports = []){
    $post_types  = cyberguard_get_post_type_options($pt_supports); 
    $result = [];
    if (!is_array($post_types))
        return $result;
    foreach ($post_types as $name => $label) {
        $result[] = array(
            ...
            'type'     => 'layoutcontrol',
            'default' => 'portfolio-1',
            'options'  => cyberguard_get_portfolio_click_layout_options($name),
            'prefix_class' => 'portfolio-layout-',
            'condition' => [
                'post_type' => [$name]
            ]
...
function cyberguard_get_portfolio_click_layout_options($post_type_name){
    $option_layouts = [];
    switch ($post_type_name) {
...
/* Icon render */ 
function cyberguard_elementor_icon_render( $settings, $args = []){
...
function cyberguard_widget_animate() {
    $cyberguard_animate = array(
        '' => 'None',
        'wow bounce' => 'bounce',
        'wow flash' => 'flash',
        'wow pulse' => 'pulse',
    ...
    return $cyberguard_animate;
}

function cyberguard_widget_animate_v2() {
    $cyberguard_animate_v2 = array(
        '' => 'None',
        'wow bounce' => 'bounce',
        'wow flash' => 'flash',
        'wow pulse' => 'pulse',
    ...
    return $cyberguard_animate_v2;
}

/**
 * Pagram Animation
*/
if(!function_exists('cyberguard_widget_animation_settings')){
    function cyberguard_widget_animation_settings($args = []){
        $args = wp_parse_args($args, [
        ...
        return array(
            ...
            'label'     => esc_html__('Animation', 'cyberguard'),
            'tab'       => $args['tab'],
            ...
            'controls'  => array_merge(
                array(
                    array(
                        'name' => 'pxl_animate',
                        'label' => esc_html__('Case Animate', 'cyberguard' ),
...
if(!function_exists('cyberguard_widget_color_type')){
    function cyberguard_widget_color_type($args = []){
        ...
        $options = array(
            array(
                ...
                'label' => esc_html__('Color Type', 'cyberguard' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'normal' => 'Normal',
                    'gradient' => 'Gradient',
            ...
            array(
                ...
                'label' => esc_html__('Normal Color', 'cyberguard' ),
            ...
            array(
                ...
                'label' => $args['label'] .' '.esc_html__('Gradient Color', 'cyberguard' ),
            ...
            array(
                ...
                'label'       => ucfirst( str_replace('_', '', $args['prefix']) ).' '. esc_html__( 'Start Popover', 'cyberguard' ),
                'type'        => 'pxl_start_popover',
                'condition'   => $args['condition'],
            ),
            array(
                'name' => $args['prefix'].'_gradient_color_from',
                'label' => esc_html__('From', 'cyberguard' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
            ...
            array(
                ...
                'label' => esc_html__('To', 'cyberguard' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
            ...
            array(
                ...
                'label'       => ucfirst( str_replace('_', '', $args['prefix']) ).' '. esc_html__( 'End Popover', 'cyberguard' ),
...
if(!function_exists('cyberguard_widget_gradient_color')){
    function cyberguard_widget_gradient_color($args = []){
        $gradient_prefix_class = 'pxl-';
        $gradient_return_value = 'gradient';
        $args = wp_parse_args($args, [
            'label' => '',
...
if(!function_exists('cyberguard_widget_gradient_color_rotate')){
    function cyberguard_widget_gradient_color_rotate($args = []){
        $gradient_prefix_class = 'pxl-';
        $gradient_return_value = 'gradient';
        $args = wp_parse_args($args, [
            'label' => '',
        ...
        $options = array(
            ...
            array(
                ...
                'label' => esc_html__('Angle', 'cyberguard' ),
