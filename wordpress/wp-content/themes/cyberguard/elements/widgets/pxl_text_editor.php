...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Text Editor', 'cyberguard'),
        'icon' => 'eicon-text',
        ...
        'params' => array(
            'sections' => array(
                array(
                    ...
                    'label' => esc_html__('Text Editor', 'cyberguard' ),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'cyberguard' ),
                        ...
                        array(
                            'name' => 't_width',
                            'label' => esc_html__('Max Width', 'cyberguard' ),
                ...
                array(
                    ...
                    'label' => esc_html__('Parallax', 'cyberguard' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        [
                            'name' => 'pxl_parallax',
                            'label' => esc_html__( 'Parallax Type', 'cyberguard' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                ''        => esc_html__( 'None', 'cyberguard' ),
                                'x'       => esc_html__( 'Transform X', 'cyberguard' ),
                                'y'       => esc_html__( 'Transform Y', 'cyberguard' ),
                                'z'       => esc_html__( 'Transform Z', 'cyberguard' ),
                                'rotateX' => esc_html__( 'RotateX', 'cyberguard' ),
                                'rotateY' => esc_html__( 'RotateY', 'cyberguard' ),
                                'rotateZ' => esc_html__( 'RotateZ', 'cyberguard' ),
                                'scaleX'  => esc_html__( 'ScaleX', 'cyberguard' ),
                                'scaleY'  => esc_html__( 'ScaleY', 'cyberguard' ),
                                'scaleZ'  => esc_html__( 'ScaleZ', 'cyberguard' ),
                                'scale'   => esc_html__( 'Scale', 'cyberguard' ),
                            ],
                        ],
                        [
                            'name' => 'parallax_value',
                            'label' => esc_html__('Value', 'cyberguard' ),
                        ...
                        [
                            ...
                            'label'   => esc_html__( 'Parallax In Screen', 'cyberguard' ),
                            'type'    => \Elementor\Controls_Manager::SELECT,
                            'control_type' => 'responsive',
                            'default' => '',
                            'options' => array(
                                '' => esc_html__( 'Default', 'cyberguard' ),
                                'no'   => esc_html__( 'No', 'cyberguard' ),
                            ),
                ...
                array(
                    ...
                    'label' => esc_html__('Highlight', 'cyberguard' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
